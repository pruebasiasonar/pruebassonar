...
namespace PlataformaTransparencia.Modulo.Principal.Controllers.Emergencia
{
    public class EmergenciasController : Controller
    {
        ...
        public ActionResult ContratosEmergencia(int emergencia, string entidad = null, string proceso = null)
        {
            ...
            //ContratistaContract contratistaContract = new ContratistaContract();
            //contratistaContract.FillGestionContratos(entida, tipoEmergencia);
            //contratistaContract.ContratistaModel.nombreUnidadCompra = String.IsNullOrEmpty(entidad) ? null : entidad;
            //contratistaContract.ContratistaModel.codigoProceso = proceso;
            //contratistaContract.ContratistaModel.tipoEmergencia = tipoEmergencia;
            //return View(contratistaContract.ContratistaModel);
        }
