...
function getStrBarrasPerPeriodo(result, anyo_actual) {
    ...
    if (result != null) {
        ...
        $("#lblValorAprobado").text("RD$ " + formatMoney(total_aprobado, 0, '.', ',').toString());
...
function getEstructuraInfograficoPerEntidad(datos, pagina) {
    ...
    for (var i = 0; i < datos.length; i++) {
        ...
        html_list += '</div>';
        html_list += '<div class="data1"><span class="labelTit">Presupuesto Aprobado</span><span class="td1">RD$ ' + formatMoney(presup_aprobado,2, '.', ',').toString() + ' Millones</span ></div > ';
        html_list += '<div class="data1"><span class="labelTit">Presupuesto Vigente</span><span class="td1">RD$ ' + formatMoney(presup_vigente,2, '.', ',').toString() + ' Millones</span></div>';
        html_list += '<div class="data1"><span class="labelTit">Presupuesto Ejecutado</span><span class="td1">RD$' + formatMoney(presup_ejecutado,2, '.', ',').toString() + ' Millones</span></div>';
