                    ...
                    if (result.cantidadTotalRegistros > 0) {
                        ...
                        for (var i = 0; i < info.length; i++) {
                            ...
                            if (proceso != info[i].codigoProceso.toString()) {
                                ...
                                fila += '</span></div>'
                                    + '			<div class="col-xs-6 col-md-3"><span class="txt_small">Monto Estimado<span class="amount_adj">RD$ ' + (info[i].MontoEstimadoProceso * 1).formatMoney(2, '.', ',').toString() + '</span></div>'
                            ...
                            if (info[i].codigoContrato) {
                                ...
                                if (info[i].codigoOrigenInformacion === 2 || info[i].codigoOrigenInformacion === 1) { filaconfirma += '                        <span class="badge"><img src="../img/ic-mini-contract.svg" alt="icono contrato"> FIONA</span>'; }
                                ...
                                filaconfirma += '</div>'
                                    ...
                                    + '                        <div class="col-xs-8 col-md-3"><span class="small"> VALOR CONTRATADO</span><span class="amount_adj">RD$ ' + (info[i].valorContratado * 1).formatMoney(2, '.', ',').toString() + ' </span></div>' //RD$ ' + (info[i].MontoContratadoTotalContrato * 1).formatMoney(2, '.', ',').toString() + ' 
                                ...
                                if (info[i].codigoContrato) {
                                    filaconfirma += '                    <a href="../../contratista/contratoprofile/?CodigoContrato=' + info[i].codigoContrato.toString() + '" class="btn btn-primary btn-primary btn-participe"><span class="glyphicon glyphicon-comment"></span> Más detalles del contrato </a>';
                                }
                                filaconfirma += '                 </div>'
                                    + '            </div>'
                                    + '        </div>';
